...
def get_budget_for_month(session: Session, month: date, category_group_id: int) -> MonthlyBudgetRes:
    statement = (
    ...
    total = get_total_budget_for_month(session, month, category_group_id)
